...
export const metadata: Metadata = {
  ...
  description:
    'Découvrez les dynasties verrières, les aventures industrielles et les sagas régionales qui ont marqué l"histoire du verre.',
}
      ...
      <div className="max-w-screen-xl mx-auto py-12 md:py-16 px-4 md:px-8">
        <header className="mb-8 md:mb-12 text-center">
          ...
          <p className="mt-4 text-lg text-blueGray-600 font-sans max-w-3xl mx-auto">
            Plongez dans les sagas qui ont façonné l&apos;industrie du verre, des verreries
            forestières aux grandes manufactures.
          </p>
        </header>
