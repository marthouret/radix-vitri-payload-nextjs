  ...
  if (!verreries || verreries.length === 0) {
    return (
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-screen-xl mx-auto px-2 sm:px-4 py-3 text-center">
          ...
          {verreries.map((v) => (
            ...
            >
              {v.imageEnAvant && v.imageEnAvant.url ? (
                ...
                <div className="w-full h-48 bg-blueGray-100 flex items-center justify-center text-blueGray-400 font-sans">
                  Image N/A
                </div>
              )}
