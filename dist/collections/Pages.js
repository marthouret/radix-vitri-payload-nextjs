...
var slugs_1 = require("@/utils/slugs"); // On utilise bien votre utilitaire de base
exports.Pages = {
    slug: 'pages',
    labels: {
        singular: 'Page',
    ...
    access: {
        read: function () { return true; }, // Tout le monde peut lire les pages. Attention : seul le ID est renvoyé dan sun appel API select !
    },
    fields: [
        {
            name: 'title',
