...
var Lieu = {
    ...
    access: {
        read: function () { return true; }, // Ouvert en lecture par défaut
    },
    fields: [
        {
            name: 'typeDeLieu',
        ...
        // Champ virtuel pour l'affichage dans l'admin et les relations
        {
            ...
            access: {
                create: function () { return false; }, // Ce champ n'est pas créé directement
                update: function () { return false; }, // Ni mis à jour directement
            },
            hooks: {
                afterRead: [
                    // Modification ici: utilisation de originalDoc
                    function (_a) {
                        var originalDoc = _a.originalDoc;
